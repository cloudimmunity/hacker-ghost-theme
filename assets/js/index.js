...
function AnimatePostIndex() 
{
  if ($('.post-index-animations').length && $('.animated-post').length) 
  {
    $('.animated-post').each(function () 
    {
...
$(window).on("scroll",function()
{
  ...
  {
    $("#main-header").addClass("small-main-header");
  } else
  {
    $("#main-header").removeClass("small-main-header");
  }
});
